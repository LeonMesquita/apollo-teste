window.config = {
  ...
  studyPrefetcher: {
    ...
    displaySetCount: 3,
    preventCache: false,
    prefetchDisplaySetsTimeout: 900,
    ...
    dicomWeb: [
      {
        name: 'HIGIASERVER',
        wadoUriRoot:
          'http://medvitta.dyndns.org:5000/dcm4chee-arc/aets/HIGIASERVER/wado',
        qidoRoot:
          'http://medvitta.dyndns.org:5000/dcm4chee-arc/aets/HIGIASERVER/rs',
        wadoRoot:
          'http://medvitta.dyndns.org:5000/dcm4chee-arc/aets/HIGIASERVER/rs',
        // name: 'DCM4CHEE',
  ...
  //   authority: 'https://telerad.higiatec.com.br:8843/auth/realms/dcm4che',
