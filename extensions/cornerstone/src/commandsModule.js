...
const commandsModule = ({ servicesManager }) => {
  const actions = {
    ...
    clearAnnotations: ({ viewports }) => {
      ...
      console.log('getEnabledElements', viewports.activeViewportIndex);
      ...
      console.log('getEnabledElements', enabledElement);
      ...
      measurementsToRemove.forEach(data => {
        console.log('remocao', data);
      });
